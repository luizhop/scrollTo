...
simpleScrollTo = function (destination, options = {}) {
...
simpleScrollToHref = function (nav_item, options = {}) {

  let destination_section = document.querySelector(nav_item.getAttribute('href'));

  nav_item.addEventListener('click', () => {
    simpleScrollTo( destination_section, options );
  });
...
allSimpleScrollTo = function (nav_items, options = {}) {

  nav_items.forEach(function(nav_item){
    simpleScrollToHref( nav_item, options );
  });
